...
# ==========================
def get_date_input():
    print("\n--- GNOC Incident Report - Date Selection ---\n")
    print("Enter the date range for fetching Jira incidents.")
    print("Format: YYYY-MM-DD\n")

    while True:
        start_input = input("Start date (e.g. 2026-03-07): ").strip()
        try:
    ...
    while True:
        end_input = input("End date   (e.g. 2026-03-14): ").strip()
        try:
